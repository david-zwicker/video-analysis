...
kids.cache is a Python library providing a cache decorator. It's part of 'Kids'
(for Keep It Dead Simple) library. It has no dependency to any python library.

:copyright: (c) 2015 Valentin Lab.
:license: BSD, see LICENSE_BSD.txt for more details.

The code was copied from
https://github.com/0k/kids.cache
"""
import threading
import functools
import collections
